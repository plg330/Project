...
public class Hard_Legs extends AppCompatActivity {
    ...
    private int[][] allImages = {
            { R.drawable.pistol_squat_rest,  R.drawable.pistol_squat_down}, // images1
            { R.drawable.front_squat_rest, R.drawable.front_squat_down},     // images2
    };
