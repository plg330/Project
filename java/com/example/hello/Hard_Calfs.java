...
public class Hard_Calfs extends AppCompatActivity {
    ...
    private int[][] allImages = {
            { R.drawable.squat_heel_raise_up,  R.drawable.squat_heel_raise_down}, // images1
            { R.drawable.rope_jump_2, R.drawable.rope_jump_4},     // images2
    };

    // Text sets (reduced to one text per set)
    private String[] allTexts = {
            "45S SQUAT HEEL RAISE",
            "45S JUMP ROPE"
    };
