...
public class Hard_Abs extends AppCompatActivity {
    ...
    private int[][] allImages = {
            { R.drawable.plank_45s,  R.drawable.plank_45s}, // images1
            { R.drawable.hanging_knee_raise_rest, R.drawable.hanging_knee_raise_up},     // images2
    };

    // Text sets (reduced to one text per set)
    private String[] allTexts = {
            "60S PLANK",
            "30S HANGING KNEE RAISES"
    };
