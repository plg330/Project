...
public class Hard_Chest extends AppCompatActivity {
    ...
    private int[][] allImages = {
            { R.drawable.decline_barbell_rest,  R.drawable.decline_barbell_down}, // images1
            { R.drawable.decline_dumbbell_rest, R.drawable.decline_dumbbell_down},     // images2
    };

    // Text sets (reduced to one text per set)
    private String[] allTexts = {
            "DECLINE BARBELL BENCH PRESS 8X4",
            "DECLINE DUMBBELL BENCH PRESS 8X4"
    };
