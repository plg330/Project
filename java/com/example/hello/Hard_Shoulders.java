...
public class Hard_Shoulders extends AppCompatActivity {
    ...
    private int[][] allImages = {
            { R.drawable.overhead_press_rest,  R.drawable.overhead_press_up}, // images1
            { R.drawable.front_arm_raise_rest, R.drawable.front_arm_raise_up},     // images2
    };

    // Text sets (reduced to one text per set)
    private String[] allTexts = {
            "BARBELL OVERHEAD PRESS 10X4",
            "FRONT RAISE 10X4"
    };
