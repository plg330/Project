...
public class Normal_Tricep extends AppCompatActivity {
    ...
    private int[][] allImages = {
            {R.drawable.close_grip_bench_press_rest, R.drawable.close_grip_bench_press_up}, // images1
            {R.drawable.dumbbell_bench_press_rest, R.drawable.dumbbell_bench_press_up},     // images2
            {R.drawable.overhead_tricep_extension_rest, R.drawable.overhead_tricep_extension_up} // images3
    };

    // Text sets (reduced to one text per set)
    private String[] allTexts = {
            "CLOSE GRIP DUMBBELL PRESS 10X4",    // text for images1
            "DUMBBELL BENCH PRESS 12X4",      // text for images2
            "OVERHEAD TRICEP EXTENSION 8X4" // text for images3
    };
