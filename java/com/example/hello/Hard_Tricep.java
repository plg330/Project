...
public class Hard_Tricep extends AppCompatActivity {
    ...
    private int[][] allImages = {
            {R.drawable.tricep_dip_up, R.drawable.tricep_dip_down}, // images1
            {R.drawable.close_grip_bench_press_rest, R.drawable.close_grip_bench_press_up},     // images2
    };

    // Text sets (reduced to one text per set)
    private String[] allTexts = {
            "TRICEP DIP 10X4",    // text for images1
            "CLOSE-GRIP BENCH PRESS",      // text for images2
    };
