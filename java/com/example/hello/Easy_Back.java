...
public class Easy_Back extends AppCompatActivity {
    ...
    private int[][] allImages = {
            { R.drawable.arm_dumbbell_row_rest,  R.drawable.arm_dumbbell_row_up}, // images1
            {R.drawable.bent_over_arm_row_rest, R.drawable.bent_over_arm_row_up},     // images2
            { R.drawable.t_bar_row_rest,  R.drawable.t_bar_row_up} // images3
    };

    // Text sets (reduced to one text per set)
    private String[] allTexts = {
            "ARM DUMBBELL ROW 12X4",
            "BENT OVER ARM ROW 12X4",
            "T-BAR ROW 12X4"
    };
