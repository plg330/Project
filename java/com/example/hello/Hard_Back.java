...
public class Hard_Back extends AppCompatActivity {
    ...
    private int[][] allImages = {
            { R.drawable.pull_up_rest,  R.drawable.pull_up_up}, // images1
            { R.drawable.lying_dumbbell_tricep_extension_rest, R.drawable.lying_dumbbell_tricep_extension_up},     // images2
    };

    // Text sets (reduced to one text per set)
    private String[] allTexts = {
            "PULL UP 8X4",
            "DUMBBELL PULLOVER 8X4"
    };
