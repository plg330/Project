...
public class Easy_Abs extends AppCompatActivity {
    ...
    private int[][] allImages = {
            { R.drawable.abs_crunch_rest,  R.drawable.abs_crunch_up}, // images1
            { R.drawable.scissor_kick_left, R.drawable.scissor_kick_right},     // images2
            { R.drawable.mountain_climber_rest,  R.drawable.mountain_climber_up}, // images3
    };
