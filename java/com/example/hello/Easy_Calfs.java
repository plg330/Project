...
public class Easy_Calfs extends AppCompatActivity {
    ...
    private int[][] allImages = {
            ...
            { R.drawable.standing_dumbbell_calf_raise_rest, R.drawable.standing_dumbbell_calf_raise_up},     // images2
            { R.drawable.seated_calf_press_rest,  R.drawable.seated_calf_press_up} // images3
    };

    // Text sets (reduced to one text per set)
    private String[] allTexts = {
            "CALF RAISES 12X4",
            "STANDING DUMBBELL CALF RAISES 10X4",
            "SEATED CALF PRESS 10X4"
    };
