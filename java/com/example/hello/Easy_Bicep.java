...
public class Easy_Bicep extends AppCompatActivity {
    ...
    private int[][] allImages = {
            {R.drawable.dumbbell_curl_rest, R.drawable.dumbbell_curl_up}, // images1
            {R.drawable.hammer_curl_rest, R.drawable.hammer_curl_up},     // images2
            {R.drawable.concentration_rest, R.drawable.concentration_curl_up} // images3
    };

    // Text sets (reduced to one text per set)
    private String[] allTexts = {
            "DUMBBELL CURL 12X4",    // text for images1
            "HAMMER CURL 10X4",      // text for images2
            "CONCENTRATION CURL 8X4" // text for images3
    };
