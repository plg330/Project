...
public class Easy_Shoulders extends AppCompatActivity {
    ...
    private int[][] allImages = {
            { R.drawable.dumbbell_shouder_press_rest,  R.drawable.dumbbell_shoulder_press_up}, // images1
            { R.drawable.face_pull_rest, R.drawable.face_pull_up},     // images2
            { R.drawable.shoulder_shrug_rest,  R.drawable.shoulder_shrug_up}, // images3
    };
