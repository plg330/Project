...
public class Normal_Bicep extends AppCompatActivity {
    ...
    private int[][] allImages = {
            { R.drawable.barbell_curl_rest,  R.drawable.barbell_curl_up}, // images1
            { R.drawable.preacher_curl_rest, R.drawable.preacher_curl_up},     // images2
            { R.drawable.twisting_dumbbell_curl_rest,  R.drawable.twisting_dumbbell_curl_up}, // images3
    };
        ...
        final Runnable runnable = new Runnable() {
            ...
            public void run() {
                if (iterationCount[0] < 20) { // 10 iterations for 5 pairs (5 times alternating between 0 and 1)
                    ...
                    imageView.setImageResource(currentImages[currentIndex]);
                    iterationCount[0]++;
                    handler.postDelayed(this, 100); // 0.10 seconds delay
                } else {
