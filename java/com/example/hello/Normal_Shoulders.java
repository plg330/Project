...
public class Normal_Shoulders extends AppCompatActivity {
    ...
    private int[][] allImages = {
            { R.drawable.dumbbell_lateral_raises_rest, R.drawable.dumbbell_lateral_raise_up}, // images1
            { R.drawable.bent_over_lateral_raise_rest, R.drawable.bent_over_lateral_raise_up},     // images2
            { R.drawable.bent_over_lateral_raise_rest,  R.drawable.bent_over_lateral_raise_up}, // images3
    };

    // Text sets (reduced to one text per set)
    private String[] allTexts = {
            "DUMBBELL LATERAL RAISE 10X4",
            "BENTOVER LATERAL RAISE 10X4",
            "REVERSE FLY 12X4"
