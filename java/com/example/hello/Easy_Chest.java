...
public class Easy_Chest extends AppCompatActivity {
    ...
    private int[][] allImages = {
            { R.drawable.push_up_rest,  R.drawable.push_up_down}, // images1
            { R.drawable.seated_chest_fly_rest, R.drawable.seated_chest_fly_up},     // images2
            { R.drawable.cable_press_rest,  R.drawable.cable_press_up} // images3
    };
