...
public class Normal_Chest extends AppCompatActivity {
    ...
    private int[][] allImages = {
            { R.drawable.bench_press_rest, R.drawable.bench_press_up}, // images1
            { R.drawable.incline_dumbbell_rest, R.drawable.incline_dumbbell_up},     // images2
            { R.drawable.diamond_push_up_rest,  R.drawable.diamond_push_up_down}, // images3
    };

    // Text sets (reduced to one text per set)
    private String[] allTexts = {
            "BENCH PRESS 10X4",
            "INCLINE DUMBBELL PRESS 12X4",
            "DIAMOND PUSH UPS 8X4"
    };
