...
public class Normal_Legs extends AppCompatActivity {
    ...
    private int[][] allImages = {
            { R.drawable.barbell_squat_rest, R.drawable.barbell_squat_down}, // images1
            { R.drawable.kettle_bell_swing_rest, R.drawable.kettle_bell_swing_up},     // images2
            { R.drawable.goblet_squat,  R.drawable.goblet_squat_down}, // images3
    };
