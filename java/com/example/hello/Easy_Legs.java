...
public class Easy_Legs extends AppCompatActivity {
    ...
    private int[][] allImages = {
            { R.drawable.walking_lunge_left,  R.drawable.walking_lunge_right}, // images1
            { R.drawable.squat_rest, R.drawable.squat_down},     // images2
            { R.drawable.leg_extension_rest,  R.drawable.leg_extension_up}, // images3
            { R.drawable.leg_press_rest, R.drawable.leg_press_up}
    };
