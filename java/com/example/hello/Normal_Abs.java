...
public class Normal_Abs extends AppCompatActivity {
    ...
    private int[][] allImages = {
            { R.drawable.russian_twist_left,  R.drawable.russian_twist_right}, // images1
            { R.drawable.bicycle_kick, R.drawable.bicycle_kick2},     // images2
